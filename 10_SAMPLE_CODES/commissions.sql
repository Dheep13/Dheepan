...
SELECT VALUE INTO v_retention FROM  CS_FIXEDVALUE WHERE name = 'FV_RETENTION';
...
SELECT DISTINCT st.TENANTID, st.STAGESALESTRANSACTIONSEQ ,1, ST.BATCHNAME, ST.ORDERID,ST.LINENUMBER,ST.SUBLINENUMBER,
