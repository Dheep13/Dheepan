CREATE OR REPLACE PROCEDURE EXT.SP_INBOUND_POST_BCCTXN
()
LANGUAGE SQLSCRIPT
...
BEGIN
    ...
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
        ...
        BEGIN
            ...
            /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'ERROR in :' || '-FileName:' || v_prmtr.file_na(...) */
            CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'ERROR in :'|| '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    THEN
        ...
        EXECUTE IMMEDIATE 'CREATE STATISTICS ON '|| 'STELADMIN'|| '.'|| 'STEL_DATA_BCCBUNDLE';
        ...
        /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Update P to N for TV CE :' || v_prmtr.file_typ(...) */
        CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Update P to N for TV CE  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        ...
        /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Insert into Inbound_temp_txn with GA22=C and R(...) */
        CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Insert into Inbound_temp_txn with GA22=C and RecStattus=0  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        ...
        */
        ...
        /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || '1. Insert into STEL_DATA_SUBSCRIPTIONS :' || v(...) */
        CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || '1. Insert into STEL_DATA_SUBSCRIPTIONS  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        ...
        EXECUTE IMMEDIATE 'CREATE STATISTICS ON '|| 'STELADMIN'|| '.'|| 'STEL_DATA_SUBSCRIPTIONS';
        ...
        /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Insert stel_temp_transaction :' || v_prmtr.fil(...) */
        CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Insert stel_temp_transaction  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        ...
        EXECUTE IMMEDIATE 'CREATE STATISTICS ON '|| 'STELADMIN'|| '.'|| 'INBOUND_DATA_TXN';

        /* RESOLVE: Review semantics in source vs. target DBMS: Verify conversion from DBMS_STATS.GATHER_TABLE_STATS() to CREATE STATISTICS */

        /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'gather stats complete:' || :v_file_type |(...) */
        CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'gather stats complete:'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        ...
        EXECUTE IMMEDIATE 'CREATE STATISTICS ON '|| 'STELADMIN'|| '.'|| 'stel_Temp_transaction';
        ...
        /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'SIBC No Update in STEL_DATA_SUBSCRIPTIONS :' |(...) */
        CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'SIBC No Update in STEL_DATA_SUBSCRIPTIONS  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        ...
        /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Customer change update in STEL_DATA_SUBSCRIPTI(...) */
        CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Customer change update in STEL_DATA_SUBSCRIPTIONS  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        ...
        BEGIN 
            DECLARE EXIT HANDLER FOR SQLEXCEPTION
                ...
                BEGIN
                    ...
                    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'ERROR in STEL_DATA_SUBSCXRIPT merge. probablt (...) */
                    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'ERROR in STEL_DATA_SUBSCXRIPT merge. probablt duplicates :'|| '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
            ...
            /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'SERVICE No change update in STEL_DATA_SUBSCRIP(...) */
            CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'SERVICE No change update in STEL_DATA_SUBSCRIPTIONS  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        ...
        /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Update SERV No, Customer and Flag in STEL_DATA(...) */
        CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Update SERV No, Customer and Flag in STEL_DATA_SUBSCRIPTIONS  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        ...
        /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || '1. Update PONUMBER in INBOUND_DATA_TXN :' || v(...) */
        CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || '1. Update PONUMBER in INBOUND_DATA_TXN  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        ...
        /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || '2. Update PONUMBER in INBOUND_TEMP_TXN :' || v(...) */
        CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || '2. Update PONUMBER in INBOUND_TEMP_TXN  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
...
--Deepan : new insert code, without insert all
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Insert 30 Cancellation :' || :v_file_type(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Insert 30 Cancellation  :'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || '1.Update to ShiptoAddress:' || v_prmtr.file_ty(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || '1.Update to ShiptoAddress:'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || '2.Update to ShiptoAddress:' || v_prmtr.file_ty(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || '2.Update to ShiptoAddress:'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Delete from stel_Temp_Cessations' || v_prmtr.f(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Delete from stel_Temp_Cessations'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Insert from stel_Temp_Cessations 1' || v_prmtr(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Insert from stel_Temp_Cessations 1'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Insert from stel_Temp_Cessations 2' || v_prmtr(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Insert from stel_Temp_Cessations 2'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    */   
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Insert from stel_Temp_Cessations CE 1' || v_pr(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Insert from stel_Temp_Cessations CE 1'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Insert from stel_Temp_Cessations CE 2' || v_pr(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Insert from stel_Temp_Cessations CE 2'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Merge on inbound_Data_Txn for OrderId and othe(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Merge on inbound_Data_Txn for OrderId and other attributes'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Merge on inbound_Data_Txn for OrderId and othe(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Merge on inbound_Data_Txn for OrderId and other attributes 2'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    */
    ...
    MERGE INTO inbound_data_Txn AS tgt 
        USING
        (
            SELECT   /* ORIGSQL: (select st.orderid, st.linenumber, st.sublinenumber, nvl(nvl(x.parentpositionnam(...) */
                st.orderid,
                st.linenumber,
                st.sublinenumber,
            ...
            LEFT OUTER JOIN
                ...
                ON st.compensationdate BETWEEN X.relnstartdate AND X.relnenddate-1
            ...
            LEFT OUTER JOIN
                (
                    ...
                    AND st.compensationdate BETWEEN X2.effectivestartdate AND X2.effectiveenddate-1
                LEFT OUTER JOIN
                    (
                        SELECT   /* ORIGSQL: (select nvl(m.name,p.name) parentposnname, p.name childposnname, p.effectivestar(...) */
                            IFNULL(m.name,p.name) AS parentposnname,
                        ...
                        LEFT OUTER JOIN
                            ...
                            ON p.managerseq = m.ruleelementownerseq
                            AND m.removedate >CURRENT_TIMESTAMP   /* ORIGSQL: sysdate */
                            AND p.effectivestartdate BETWEEN m.effectivestartdate AND m.effectiveenddate-1
                            /* RESOLVE: Oracle Database link: Remote table/view 'cs_position@stelext' at Oracle DBlink 'stelext' is converted to HANA virtual table 'cs_position'; see 'dbmtk_create_remote_tables.sqlscript' for creating this virtual table. */
                            /* RESOLVE: Oracle Database link: Remote table/view 'cs_position@stelext' at Oracle DBlink 'stelext' is converted to HANA virtual table 'cs_position'; see 'dbmtk_create_remote_tables.sqlscript' for creating this virtual table. */
                        WHERE
                            p.removedate >CURRENT_TIMESTAMP   /* ORIGSQL: sysdate */
                        ...
                        AND st.compensationdate BETWEEN X3.effectivestartdate AND X3.effectiveenddate-1
                    WHERE
    ...
    */
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Update GB1' || :v_file_type || '-FileName(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Update GB1'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Update Comments' || :v_file_type || '-Fil(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Update Comments'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
        , 'Update Comments Completed', :v_rowcount, NULL, NULL);  /* ORIGSQL: SUBSTR(v_proc_name || 'Update Comments' || :v_file_type || '-FileName:' || (...) */

    v_rowcount = ::ROWCOUNT;  /* ORIGSQL: SQL%ROWCOUNT */

    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Update ceased Order' || :v_file_type || '(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Update ceased Order'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'GA6 Update in Assignment' || :v_file_type(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'GA6 Update in Assignment'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Update Assignment Key' || :v_file_type ||(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Update Assignment Key'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Update Assignment Key 2' || :v_file_type (...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Update Assignment Key 2'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Update Assignment Posn' || :v_file_type |(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Update Assignment Posn'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Update TXN TYPE to RECON' || :v_file_type(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Update TXN TYPE to RECON'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
    ...
    */ 
    ...
    /* ORIGSQL: SP_LOGGER (SUBSTR(v_proc_name || 'Update GA15 for Mobile scenarios' || v_prmtr.f(...) */
    CALL EXT.SP_LOGGER(SUBSTRING(IFNULL(:v_proc_name,'') || 'Update GA15 for Mobile scenarios'|| IFNULL(:v_file_type,'') || '-FileName:'|| IFNULL(:v_file_name,'') || '-Date:'|| IFNULL(:v_file_date,''),1,255) 
