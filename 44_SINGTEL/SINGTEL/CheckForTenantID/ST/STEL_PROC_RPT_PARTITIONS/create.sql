CREATE PROCEDURE EXT.STEL_PROC_RPT_PARTITIONS
(
...
BEGIN
    ...
    v_partitionname = 'P_' || IFNULL(REPLACE(:v_periodname, ' ', '_'),'');

    v_periodname_partition = IFNULL(CHAR(39),'') || IFNULL(:v_periodname,'') || IFNULL(CHAR(39),'');  /* ORIGSQL: CHR(39) */
    BEGIN 
