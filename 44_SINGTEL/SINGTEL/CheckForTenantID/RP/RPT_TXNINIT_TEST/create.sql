CREATE PROCEDURE EXT.RPT_TXNINIT_TEST
(
...
BEGIN
    ...
    DECLARE CURSOR dbmtk_cursor_13386
    FOR 
    ...
    DO
        ...
        THEN
            ...
            and pd.monthenddatetd-1 between t.effectivestartdate and t.effectiveenddate-1
            and st.tenantid=t.tenantid
            
            left join cs_position pos2
            on ta.positionname= pos2.name and pos2.removedate=' ||IFNULL(:v_eot,'')||'
            and  pd.monthenddatetd-1 between pos2.effectivestartdate and pos2.effectiveenddate-1
