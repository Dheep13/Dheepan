CREATE PROCEDURE EXT.RPT_D2D_TRANSDETAIL
(
...
BEGIN
    ...
    v_ComponentName = 'RPT_D2D_TRANSDETAIL';
    ...
    CALL EXT.STEL_PROC_RPT_PARTITIONS(:IN_PERIODSEQ, 'STEL_RPT_D2D_TRANSACTIONDET');
    ...
    MERGE INTO EXT.STEL_RPT_D2D_TRANSACTIONDET AS tgt
        ...
        ON(tgt.positionseq = src.ruleelementownerseq
