...
def extract_workflow_details_and_sequence(xml_path):
    ...
    # Diagnostic print to check all workflow names
    workflow_names = [wf.attrib.get('NAME', 'Unnamed') for wf in root.findall(".//WORKFLOW")]
    print("Workflow Names Found:", workflow_names)
    ...
    for workflow in workflows:
        ...
        # Always add workflow-level details to ensure all workflows are captured
