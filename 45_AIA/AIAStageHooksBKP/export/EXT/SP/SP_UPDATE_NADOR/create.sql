...
select * from ext.sh_query_result;

   Log('Gv_Processingunitseq :' || Gv_Processingunitseq ||
        'V_Componentvalue :' || V_Componentvalue ||
        'gv_periodseq :'|| gv_periodseq);
commit;
...
--Deepan : UnComment the below update statement 
