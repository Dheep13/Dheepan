CREATE Procedure Comtransferpiaor(in I_R_Agydisttrxn_row R_Agydisttrxn)
as
begin
    ...
    DECLARE v_standalone VARCHAR(30);  /* ORIGSQL: v_standalone varchar2(30); */    --add by jeff
    DECLARE v_standalone2 DECIMAL(30);  /* ORIGSQL: v_standalone2 number(30); */    --add by jeff
    DECLARE v_periodenddate TIMESTAMP;  /* ORIGSQL: v_periodenddate date; */    --add by jeff
...
--Log('C13');
       ...
       SELECT po.genericattribute11
        ...
        AND po.effectivestartdate <= add_days(v_periodenddate,-1)
        and po.effectiveenddate > add_days(v_periodenddate,-1);
       SELECT count(1) into v_standalone2 FROM TBL_PIAOR_STANDALONE where agyname=V_Writingagyldr;
...
--Log('C17');
  ...
  --                    Log('C21');
      ...
      --                Log('C22');
          ...
          SELECT count(1) into v_standalone2 FROM TBL_PIAOR_STANDALONE where agyname=V_Aorwagyldr;
