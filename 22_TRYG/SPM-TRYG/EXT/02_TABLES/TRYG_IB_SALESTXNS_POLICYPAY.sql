DROP TABLE EXT.TRYG_IB_SALESTXNS_POLICYPAY;
CREATE COLUMN TABLE EXT.TRYG_IB_SALESTXNS_POLICYPAY (
...
CREATE UNIQUE INDEX TRYG_IB_SALESTXNS_POLICYPAY_UN ON EXT.TRYG_IB_SALESTXNS_POLICYPAY (
    ORDERID ASC,
    LINENUMBER ASC,
    SUBLINENUMBER ASC,
    EVENTTYPEID ASC
