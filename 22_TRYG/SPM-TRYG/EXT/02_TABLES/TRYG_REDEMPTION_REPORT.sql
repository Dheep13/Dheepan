...
CREATE COLUMN TABLE EXT.TRYG_REDEMPTION_REPORT (
    ROWNUMBER BIGINT CS_FIXED GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    RABATGL DECIMAL(25, 10) CS_FIXED,
    RABATNY DECIMAL(25, 10) CS_FIXED,
    COMMISSIONPERCENTAGE DECIMAL(25, 10) CS_FIXED
) UNLOAD PRIORITY 5 AUTO MERGE PARTITION BY RANGE (POLICYSTARTDATE) (
    PARTITION '20190101' <=
    VALUES < '20200101',
        PARTITION '20200101' <=
    VALUES < '20210101',
