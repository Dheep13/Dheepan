...
CALL EXT.TRYG_LOG(v_procedureName,'Position Name Change after 2023-01-01 for CANC transactions',::ROWCOUNT);	
...
CALL EXT.TRYG_LOG(v_procedureName,'Sum of credits to date for each transaction updated in ext.tryg_clawback_credits ',::ROWCOUNT);	
...
CALL EXT.TRYG_LOG(v_procedureName,'Position Name Change after 2023-01-01 for DECR transactions',::ROWCOUNT);	
...
CALL EXT.TRYG_LOG(v_procedureName,'Position Name Change after 2023-01-01 for GENI/GESK transactions',::ROWCOUNT);	
