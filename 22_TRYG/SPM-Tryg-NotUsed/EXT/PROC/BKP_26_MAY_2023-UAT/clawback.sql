CREATE OR REPLACE PROCEDURE EXT.TRYG_SH_CLAWBACK_26MAY23_BKP ( in_PeriodSeq BIGINT,in_ProcessingUnitSeq BIGINT) 
LANGUAGE SQLSCRIPT 
...
insert into ext.tryg_clawback_credits (
                            ...
                            FROM cs_salestransaction st_prev,
                                ...
                                and st_prev.genericdate3 <=geni_txn.geni_compdate
                                and st_prev.genericdate3 > add_months(geni_txn.geni_compdate,-12)
...
using
(select ta.salestransactionseq ta_salestransactionseq,
...
ta.setnumber as ta_setnumber,
ta.positionname as ta_positionname
...
and tas.setnumber=subq.ta_setnumber
and tas.positionname=subq.ta_positionname
