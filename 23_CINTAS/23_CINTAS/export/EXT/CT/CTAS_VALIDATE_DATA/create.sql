CREATE PROCEDURE EXT.CTAS_VALIDATE_DATA(IN PROCNAME VARCHAR(255), IN BATCHNAME VARCHAR(255),  IN IN_FILTER VARCHAR(1000), OUT p_status INT, OUT p_message NVARCHAR(100))
