...
truncate table ext.ctas_otpercent_prestage;
...
-- truncate table ext.ctas_otpercent_error;
...
CALL ext.ctas_validate_data(::CURRENT_OBJECT_NAME,:FILENAME,v_status, v_message);
